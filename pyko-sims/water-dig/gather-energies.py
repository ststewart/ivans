...
for ineb in range(npn): # vary nebula
    fout='./data/water-dig/vp-h2o-dig-tempgridlong-p1Pa/vp-h2o-tempgridlong-'+plume.pneb[ineb]+'-'
    if ineb > 0:
        fout='./data/water-dig/vp-h2o-dig-tempgridlong-p1Pa/vp-h2o-tempgridlong-'+plume.pneb[ineb]+'-150-'
