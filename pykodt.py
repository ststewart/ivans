...
VERSIONS
    ...
    2023-07-05: v0.7 -- differentiate from public release
...
#
# GLOBAL VARIABLE
__version__ = 'v0.8.3-dev-2024-05-12' 
...
#
@profile
def run(fin='pyko.yml',fout='pyko-output.dat',ftype='YAML',verbose=True,userdtstart=0.,usertstepscale=0.,binoutput=True,debug=False,initarr=False):
    ############################################################## 
